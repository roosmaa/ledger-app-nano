...
#define NANO_INS_VALIDATE_BLOCK 0x03
#define NANO_INS_SIGN_BLOCK 0x04
#define NANO_INS_SIGN_NONCE 0x05
...
#define NANO_SW_INVALID_SIGNATURE 0x6A81
#define NANO_SW_PARENT_BLOCK_CACHE_MISS 0x6A82
