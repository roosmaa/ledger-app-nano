...
MAX_ADPU_INPUT_SIZE=153
MAX_ADPU_OUTPUT_SIZE=99
# U2F_MAX_MESSAGE_SIZE=MAX(129 + $(MAX_ADPU_INPUT_SIZE), 7 + $(MAX_ADPU_OUTPUT_SIZE))
U2F_MAX_MESSAGE_SIZE=282
...
DEFINES   += U2F_MAX_MESSAGE_SIZE=$(U2F_MAX_MESSAGE_SIZE)
